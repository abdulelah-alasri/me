# 📱 نظام الشاطر واتساب - Automated Business Intelligence System
...
**نظام الشاطر واتساب** هو حل متكامل لأتمتة عمليات استعلام البيانات من نظام Onyx Pro لإدارة الأعمال (من شركة يمن سوفت) عبر تطبيق واتساب. يسمح النظام للمستخدمين بالحصول على المعلومات المطلوبة بشكل فوري ومنظم عبر واتساب بدون الحاجة للدخول إلى النظام مباشرة.
...
**الميزات**:
- 🔌 اتصال آمن مع قاعدة بيانات MySQL/Oracle
...
**الرسالة المرسلة**:
```
404#خالد العواضي###SAR
```

**الرد المتوقع**:
```
💰 كشف حساب الحساب (الاسم: خالد العواضي)
